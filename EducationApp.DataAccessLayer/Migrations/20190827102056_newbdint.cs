...
{
    public partial class newbdint : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutorInPrintingEditions", x => new { x.AutorId, x.PrintingEditionId });
                    table.ForeignKey(
                        name: "FK_AutorInPrintingEditions_Autors_AutorId",
                        column: x => x.AutorId,
                        principalTable: "Autors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutorInPrintingEditions_PrintingEditions_PrintingEditionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutorInPrintingEditions_PrintingEditionId",
                table: "AutorInPrintingEditions",
